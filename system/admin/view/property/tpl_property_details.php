                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 clearfix">
                            ...
                            <table class="table table-striped table-bordered table-condensed table-hover ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ($this->property_data['status']) ? '<span class="label label-sm label-success">Aktív</span>' : '<span class="label label-sm label-danger">Inaktív</span>'; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Megbízás típusa:</td>
                                        <td><?php echo ($this->property_data['tipus'] == '1') ? '<span class="label label-sm label-default">Eladó</span>' : '<span class="label label-sm label-primary">Kiadó</span>'; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Kategória:</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ($this->property_data['kiemeles']) ? '<span class="label label-sm label-info"><i class="fa fa-check"></i></span>' : '<span class="label label-sm label-default"><i class="fa fa-minus"></i></span>'; ?></td>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            echo $this->property_data['hazszam'] . '&nbsp';
                                            echo (!empty($this->property_data['emelet'])) ? $this->property_data['emelet'] . '. emelet ' : '';
                                            echo (!empty($this->property_data['emelet_ajto'])) ? $this->property_data['emelet_ajto'] : '';
                                            ?>
                                    </tr>
                                    <tr>
                                        <td>Tetőtéri lakás:</td>
                                        <td><?php echo ($this->property_data['tetoter']) ? '<span class="label label-sm label-info"><i class="fa fa-check"></i></span>' : '<span class="label label-sm label-default"><i class="fa fa-minus"></i></span>'; ?></td>
                                    </tr> 
                                    <tr>
                                        <td>Megjelenítés térképen:</td>
                                        <td><?php echo ($this->property_data['terkep']) ? '<span class="label label-sm label-info"><i class="fa fa-check"></i></span>' : '<span class="label label-sm label-default"><i class="fa fa-minus"></i></span>'; ?></td>
                                    </tr> 
                                    <tr>
                                        <td>Utca megjelenítés:</td>
                                        <td><?php echo ($this->property_data['utca_megjelenites']) ? '<span class="label label-sm label-info"><i class="fa fa-check"></i></span>' : '<span class="label label-sm label-default"><i class="fa fa-minus"></i></span>'; ?></td>
                                    </tr> 
                                    <tr>
                                        <td>Házszám megjelenítés:</td>
                                        <td><?php echo ($this->property_data['hazszam_megjelenites']) ? '<span class="label label-sm label-info"><i class="fa fa-check"></i></span>' : '<span class="label label-sm label-default"><i class="fa fa-minus"></i></span>'; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-striped table-bordered table-condensed table-hover ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Félszobák:</td>
                                        <td><?php echo $this->property_data['felszobaszam']; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr> 
                                        <td>Emelet:</td>
                                        <td><?php echo (isset($this->property_data['emelet'])) ? $this->property_data['emelet'] . '.' : '-'; ?>
                                        </td>
                                    </tr>
                                    ...
                                    if ($this->property_data['emelet']) {
                                        ...
                                        echo '<td>';
                                        echo ($this->property_data['epulet_szintjei']) ? $this->property_data['epulet_szintjei'] : 'n.a.';
                                        ;
                                        echo '</td>';
                                        echo '</tr>';
                                    }
                            ...
                            <table class="table table-striped table-bordered table-condensed table-hover ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Lift:</td>
                                        <td><?php echo ($this->property_data['lift'] == 1) ? '<span class="label label-sm label-info"><i class="fa fa-check"></i></span>' : '<span class="label label-sm label-default"><i class="fa fa-minus"></i></span>'; ?></td>
                                    </tr>

                                    <tr>
                                        <td>Bútorozott:</td>
                                        <td><?php echo ($this->property_data['butor'] == 1) ? '<span class="label label-sm label-info"><i class="fa fa-check"></i></span>' : '<span class="label label-sm label-default"><i class="fa fa-minus"></i></span>'; ?></td>
                                    </tr>
