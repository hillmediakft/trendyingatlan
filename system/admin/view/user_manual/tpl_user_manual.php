<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h3><legend>Trendy ingatlan CMS dokumentáció</legend></h3>
                ...
                <div class="row profile-account documentation">
                    <div class="col-md-3">
                        <ul class="ver-inline-menu tabbable margin-bottom-10">
                            ...
                            <li ><a data-toggle="tab" href="#tab_2-2"><i class="fa fa-list"></i> Ingatlanok listája</a></li>
                            <li ><a data-toggle="tab" href="#tab_3-3"><i class="fa fa-edit"></i> Ingatlan felvitele</a></li>  
                            <li ><a data-toggle="tab" href="#tab_4-4"><i class="fa fa-picture-o"></i> Képek feltöltése</a></li> 
                            <li ><a data-toggle="tab" href="#tab_5-5"><i class="fa fa-file-text-o"></i> Fájlok feltöltése</a></li>   
                            <li ><a data-toggle="tab" href="#tab_6-6"><i class="fa fa-file-text"></i> Oldalak szerkesztése</a></li>
...
<!-- ****************************** A CMS RENDSZERRŐL ***************************** -->                                
                            <div id="tab_1-1" class="tab-pane active">
                                <h3>Trendy ingatlan tartalomkezelő rendszer (CMS)</h3>
...
<h4><i class="fa fa-chevron-circle-right"></i> Szűrés (összetett keresés)</h4>
                                ...
                                <p>A szűrés sáv jobb sarkára kattintva nyílik le az összetett keresést biztosító kereső űrlap. A keresési feltételek a "törlés" gomba kattintva törölhetők.</p>
...
<img src="<?php echo ADMIN_IMAGE; ?>ingatlan_kereses.jpg" class="img-thumbnail">                                    
...
<img src="<?php echo ADMIN_IMAGE; ?>uj_ingatlan.jpg" class="img-thumbnail">                                      
                                
                                <h4><i class="fa fa-chevron-circle-right"></i> Alap adatok</h4>                                   
<p>A referens kód mezőbe automatikusan a bejelentkezett felhasználó kódja kerül, ez a mező nem szerkeszthető.</p>
                             ...
                             <h4><i class="fa fa-chevron-circle-right"></i> Cím és megjelenítés</h4> 
                              ...
                              <p>Az ingatlan földrajzi koordinátáinak meghatározása (a térképes megjelenítéshez) a cím adatok alapján történik, ezért fontos, hogy minden adat pontos legyen. A front oldalon (ingatlan adatlap) a térképen nem az ingatlan pontos pozíciója jelenik meg, hanem egy néhányszáz méteres kör jelzi az ingatlan pozícióját.</p>
...
<h4><i class="fa fa-chevron-circle-right"></i> Jellemzők</h4>                                   
                              ...
                              <p>A jellemzők fül alatt az ingatlan különféle jellemzői választhatók ki illetve adhatók meg. </p>
                              
<h4><i class="fa fa-chevron-circle-right"></i> A tulajdonos adatai</h4>                                  
                              
                              <p>A tulajdonos adatainak megadása segíti a tulajdonos alapján történő keresést, és azért, hogy egyértelműen a tulajdonosához tudjuk a rögzítendő ingatlant kapcsolani, a tulajdonos neve és telefonszáma mezők kitöltése kötelező.</p>
                                
<h4><i class="fa fa-chevron-circle-right"></i> Képek és dokumentumok feltöltése</h4>                                  
                              
                              <p>Képek feltöltéséhez először el kell menteni az ingatlant (a "mentés és folytatás” gombra kattintással), a kötelezően megadandó adatokkal. A mentés után az ingatlan bekerül az adatbázisba, és már tölthetők fel hozzá képek. A képek feltöltöltéséről részleteseb információ a "képek feltöltése" szekcióban.</p>
                              
                              <p>A dokumentumok / fájlok feltöltésére ugyanaz vonatkozik, mint a képekre: először el kell menteni az ingatlant. A dokumentumok / fájlok feltöltöltéséről részleteseb információ a "fájlok feltöltése" szekcióban.</p>
...
<p>Az adatok kitöltése és elmentése után elkezdhetjük a képek feltöltését. Képek egyenként és csoportosan is feltölthetők. A kiválasztott képek a képek hozzáadása dobozban jelennek meg. Amelyiket mégsem akarjuk feltöltei, az egyszerűen eltávolítható a „kuka” ikonra kattintva.</p>

<img src="<?php echo ADMIN_IMAGE; ?>ingatlan_kep_feltoltes.jpg" class="img-thumbnail"> 
...
<!-- ****************************** KÉPEK FELTÖLTÉSE ***************************** -->                                
                            <div id="tab_5-5" class="tab-pane">
                                <h3>Fájlok / dokumentumok feltöltése</h3>
                                
<p>A dokumentumok feltöltése hasonlóan történik, mint a képek feltöltése, de ebben az esetben nincs sorrend módosító funkció. </p>

<img src="<?php echo ADMIN_IMAGE; ?>ingatlan_doc_feltoltes.jpg" class="img-thumbnail">
...
<!-- ****************************** Oldalak szerkesztése ***************************** -->									
                            ...
                            <div id="tab_9-9" class="tab-pane">
                                ...
                                <p>A V-Frameworkben a felhasználók felhasználói csoportokba tartoznak. A egyes felhasználói csoportok különböző jogosultságokkal rendelkeznek, és ennek megfelelően eltérő adminisztrációs felületet érhetnek el. </p>
                                <h4><i class="fa fa-chevron-circle-right"></i> Felhasználói jogosultságok</h4>        
                                <p>Kétféle jogosultság létezik az adminisztrációs rendszerben: szuperadminisztrátor és adminisztrátor. A szuperadminisztrátor létrehozhat új felhasználót, és törölhet admininsztrátor jogosultságú felhasználót. Az adminisztrátor nem hozhat létre és nem törölhet felhasználót. Egyéb tekintetben megegyeznek a felhasználói jogosultságok.
                                </p>
                            ...
                            <div id="tab_10-10" class="tab-pane">
                                ...
                                <p>A felhasználók, a galéria valamint az egyes modulokban feltöltött képeket a rendszer a megfelelő méretben tölti fel a szerverre (általában egy kisebb és egy nagyobb méretben), és az UPLOADS mappa megfelelő almappáiba kerülnek.   
                                <p>
                                <p>Amennyiben a képgalériában képet akar törölni, akkor azt semmiképpen se fájlkezelővel vagy ftp-n keresztül tegye meg. Használja a képgalériában a kép törlés funkciót.</p> 
         ...
         <!-- *********************** BEÁLLÍTÁSOK ************************* -->
                            <div id="tab_12-12" class="tab-pane">
                                ...
                                <ul>
                                    ...
                                    <li>E-mail cím - a weblap különböző helyein (kezdőoldal, kapcsolat, footer) megjelenő e-mail. Erre az e-mail címre érkeznek a weboldalról küldött üzenetek.</li>
                                    <li>Telefon - a weblap különböző helyein (kezdőoldal, kapcsolat, footer) megjelenő telefonszám</li>
                                   
                                    <li>Ingatlanok listázásakor az oldalanként megjelenített elemek száma</li>
