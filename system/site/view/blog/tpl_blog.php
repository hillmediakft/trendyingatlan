<div class="pagecrumbs">
    <div class="container">
        <div class="row">
            <div class="col-xs-4">
                <h5 class="medium"><?php echo $this->registry->language['menu_blog']; ?></h5>
            </div>
            <div class="col-xs-8">
                <div class="location pull-right">
                    <a href="<?php echo $this->registry->site_url; ?>"><?php echo $this->registry->language['menu_home']; ?></a> / <a href="javascript:void(0);"><?php echo $this->registry->language['menu_blog']; ?></a>
                </div>
            </div>
        </div>
    </div>
				...
				<div class="element row">
                    ...
                    <div class="col-md-7 col-sm-7">
                        <div class="body">
                            ...
                            <p class="text">
                               <?php echo Util::sentence_trim($value['blog_body_' . $this->registry->lang], 3); ?>
